                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form class="add-new-record modal-content pt-0"
                                action="{{ route('dashboard.post.update', $post->id) }}" method="post"
                                            ...
                                            @foreach (config('app.languge') as $key => $lang)
                                                <div class="tab-pane fade  show @if ($loop->index == 1) active in @endif"
                                                    ...
                                                    <div class="col-md-4 col-12 mb-3 position-relative"
                                                        ...
                                                        <textarea class="form-control" id="title" name="{{ $key }}[title]">{{ $post->translate($key)->title }}</textarea>
                                                    </div>
                                                    <label>{{ __('word.content') }}</label>
                                                    <textarea type="text" class="form-control" id="contant" name="{{ $key }}[contant]">{{ $post->translate($key)->contant }}</textarea>
                                                    <br>
                                                    <div>
                                                        ...
                                                        {{-- <input type="text" class="form-control"
                                                            ...
                                                            id="editor" /> --}}
                                                        <textarea class="form-control" name="{{ $key }}[smallDesc]" id="smallDesc">{{ $post->translate($key)->smallDesc }}</textarea>
                                                    </div>
                                                    <div>
                                                        ...
                                                        {{-- <input type="text" class="form-control"
                                                            name="{{ $key }}[smallDesc]" required
                                                            id="editor" /> --}}
                                                        <textarea class="form-control" name="{{ $key }}[tags]" id="tags">{{ $post->translate($key)->tags }}</textarea>
                                                    </div>
