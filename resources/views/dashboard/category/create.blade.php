                                        ...
                                        <div class="modal-body flex-grow-1">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select class="form-label" name="parent" id="parent">
                                                    ...
                                                    <option value="{{$categorise->id}}">{{$categorise->title}}</option>
                                                ...
                                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                    @foreach (config('app.languge') as $key => $lang)
                                                        <li class="nav-link" role="presentation">
                                                            <button class="nav-link  @if ($loop->index == 0) active @endif" id="home-tab"
                                                                data-bs-toggle="tab" data-bs-target="#{{ $key }}" type="button" role="tab"
                                                                aria-controls="{{ $key }}" aria-selected="true">{{ $lang }}</button>
                                                        </li>
                                                    @endforeach
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                @foreach (config('app.languge') as $key => $lang)
                                                    <div class="tab-pane fade  show @if ($loop->index == 1) active in @endif"
                                                        ...
                                                        <input type="text" class="form-control" name="{{ $key }}[content]" required
                                                            value="" />
