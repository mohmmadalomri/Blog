                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="index.html">
                            ...
                            <h2 class="brand-text text-primary ms-1">Sign in</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Welcome to My Blog! 👋</h2>
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a
                                                href="{{ route('password.request') }}"><small>ForgotPassword?</small></a>
                                        </div>
                                    ...
                                    <button class="btn btn-primary w-100" tabindex="4" type="submit">Sign
                                        in</button>
                                </form>
                                ...
                                <div class="auth-footer-btn d-flex justify-content-center">
                                    ...
                                    <a class="btn btn-twitter white" href="#">
                                        <i data-feather="twitter"></i></a><a class="btn btn-google" href="#">
                                        <i data-feather="mail"></i></a><a class="btn btn-github" href="#">
