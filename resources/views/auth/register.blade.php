                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="{{ route('register') }}">
                            ...
                            <h2 class="brand-text text-primary ms-1">Sign up</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-register-form mt-2" action="{{ route('register') }}"
                                    ...
                                    <div class="mb-1">
                                        <label class="form-label" for="password_confirmation">Confarm Password</label>
                                        <div class="input-group input-group-merge form-password-toggle">
                                    ...
                                    <button class="btn btn-primary w-100" tabindex="5" type="submit">Sign
                                        up</button>
                                </form>
